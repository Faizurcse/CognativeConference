  ...
  return (
    <div>
      ...
      <div style={styles.container}>
        ...
        <p style={styles.paragraph}>Last updated: November 17, 2023</p>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>Interpretation and Definitions</h2>
          <h3 style={styles.subsubheading}>Interpretation</h3>
          <p style={styles.paragraph}>
            The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
          </p>
          <h3 style={styles.subsubheading}>Definitions</h3>
          <p style={styles.paragraph}>
          ...
          <ul style={styles.list}>
            ...
            <li>
              <strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to Stripe Conferences, Palo Alto, California 94303, United States.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Stripe Conferences, accessible from www.cognitivetechsummit.com.
            </li>
            <li>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>Acknowledgment</h2>
          <p style={styles.paragraph}>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>"AS IS" and "AS AVAILABLE" Disclaimer</h2>
          <p style={styles.paragraph}>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>Disputes Resolution</h2>
          <p style={styles.paragraph}>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>For European Union (EU) Users</h2>
          <p style={styles.paragraph}>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>United States Legal Compliance</h2>
          <p style={styles.paragraph}>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>Severability and Waiver</h2>
          <h3 style={styles.subsubheading}>Severability</h3>
          <p style={styles.paragraph}>
            If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.
          </p>
          <h3 style={styles.subsubheading}>Waiver</h3>
          <p style={styles.paragraph}>
        ...
        <section style={styles.section}>
          <h2 style={styles.subheading}>Translation Interpretation</h2>
          <p style={styles.paragraph}>
            These Terms and Conditions may be translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.
          </p>
        </section>

        <section style={styles.section}>
          <h2 style={styles.subheading}>Changes to These Terms and Conditions</h2>
          <p style={styles.paragraph}>
